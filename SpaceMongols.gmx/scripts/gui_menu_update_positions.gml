...
with (argument0) {
    ...
    for (i=0;i<ds_list_size(components);i++) {
        ...
        if (orientation == GUI_ORIENTATION_VERTICAL) {
            ...
            component.x = x;
            component.y = y+h;
            component.image_xscale = width/sprite_get_width(component.sprite_index);
            component.image_yscale = component.width/sprite_get_height(component.sprite_index);
            ...
            component.x = x+h;
            component.y = y;
            component.image_xscale = component.width/sprite_get_width(component.sprite_index);
            component.image_yscale = width/sprite_get_height(component.sprite_index);
            //Increase this menu's own height to fit the new component
            h += component.width;
